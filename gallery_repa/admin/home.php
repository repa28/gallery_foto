  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
      <div class="navbar-nav me-auto">
        <a href="home.php" class="nav-link"><i class="bi bi-house-door-fill"></i></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form action="../config/proses_komentar.php" method="POST">
        <input type="hidden" name="fotoid" value="<?php echo $data['userid']?>">
        Apakah anda yakin akan menghapus data <strong><?php echo $data['isikomentar'] ?></strong> ?
                        ...
                        <form action="../config/proses_komentar.php" method="POST">
                          <div class="input-group">
                            ...
                            <div class="input-group-prepend">
                              <button type="submit" name="kirimkomentar" class="btn btn-outline-primary"><i class="bi bi-cursor-fill"></i></button>
                            </div>
                          </div>
                        </form>
                      </div>
...
<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
    <p>&copy; UKK RPL 2024 | Repa Lestari</p>
</footer>
